...
namespace PAMELA
{
	...
	TopologicalAdjacency::~TopologicalAdjacency()
	{
	...
	Adjacency* TopologicalAdjacency::get_Adjacency(ELEMENTS::FAMILY source, ELEMENTS::FAMILY target, ELEMENTS::FAMILY base)
	{
	...
	void TopologicalAdjacency::ClearAfterPartitioning(std::set<int> PolyhedronOwned, std::set<int> PolyhedronGhost, std::set<int> PolygonOwned, std::set<int> PolygonGhost)
	{
	...
	Adjacency* TopologicalAdjacency::get_Adjacency(PolyhedronCollection* source, PointCollection* target, PolyhedronCollection* base)
	{
	...
	Adjacency* TopologicalAdjacency::get_Adjacency(PointCollection* source, PolyhedronCollection* target, PolyhedronCollection* base)
	{
	...
	Adjacency* TopologicalAdjacency::get_Adjacency(PolyhedronCollection* source, PolygonCollection* target, PolyhedronCollection* base)
	{
	...
	Adjacency* TopologicalAdjacency::get_Adjacency(PolygonCollection* source, PolyhedronCollection* target, PolyhedronCollection* base)
	{
	...
	Adjacency* TopologicalAdjacency::get_Adjacency(PolyhedronCollection* source, PolyhedronCollection* target, PolygonCollection* base)
	{
	...
	Adjacency* TopologicalAdjacency::adjacencyExist(ELEMENTS::FAMILY source, ELEMENTS::FAMILY target, ELEMENTS::FAMILY base)
	{
	...
	Adjacency* TopologicalAdjacency::transposed(Adjacency* input)
	{
	...
	Adjacency* TopologicalAdjacency::multiply(Adjacency* input_lhs, Adjacency* input_rhs)
	{
