	...
	Mesh* Gmsh_mesh::CreateMesh(std::string file_path)
	{
		...
		while (StringUtils::safeGetline(mesh_file, line))
		{
			if ((line == "$Nodes"))
			{
				...
				{
					mesh_file >> id >> x >> y >> z;
					auto res =  mesh->addPoint(elementType, i, 1, x, y, z);
          ...
          if(attribute == 0) attribute = 1; // Cant have a 0 attribute
					...
					case 2:	//TRIANGLE
						...
						mesh->addPolygon(elementType, nPolygon, attribute, vertexTemp3);
						mesh->get_PolygonCollection()->MakeActiveGroup(attribute);
						nPolygon++;
						m_ntriangles++;
						break;
					...
					case 3:	//QUADRANGLE
						...
						mesh->addPolygon(elementType, nPolygon, attribute, vertexTemp4);
						mesh->get_PolygonCollection()->MakeActiveGroup(attribute);
						nPolygon++;
						m_nquadrangles++;
						break;
					...
					case 4:	//TETRAHEDRON
						...
						mesh->addPolyhedron(elementType, nPolyhedron, attribute, vertexTemp4);
						mesh->get_PolyhedronCollection()->MakeActiveGroup(attribute);
						nPolyhedron++;
						m_ntetrahedra++;
						break;
					...
					case 5:	//HEXAHEDRON
						...
						mesh->addPolyhedron(elementType, nPolyhedron, attribute, vertexTemp8);
						mesh->get_PolyhedronCollection()->MakeActiveGroup(attribute);
						nPolyhedron++;
						m_nhexahedra++;
						break;
					...
					case 6:	//PRISM
						...
						mesh->addPolyhedron(elementType, nPolyhedron, attribute, vertexTemp6);
						mesh->get_PolyhedronCollection()->MakeActiveGroup(attribute);
						nPolyhedron++;
						m_nprisms++;
						break;
					...
					case 7:	//PYRAMID
						...
						mesh->addPolyhedron(elementType, nPolyhedron, attribute, vertexTemp5);
						mesh->get_PolyhedronCollection()->MakeActiveGroup( attribute );
						nPolyhedron++;
						m_npyramids++;
						break;
